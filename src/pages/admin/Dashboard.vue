   ...
   <div class="flex justify-center items-center bg-blue-200">
      <div class="">
         <div class="grid grid-cols-12 gap-4 xl:grid-rows-5 lg:grid-rows-10 grid-rows-10 w-screen xl:h-screen p-4">
            <div
               class="z-50 lg:col-span-1 col-span-12 min-w-16 bg-gradient-to-b from-primary-lighter-2 to-primary-darker w-20 xl:row-span-5 lg:row-span-10 row-span-1 rounded-3xl">
               <Sidebar />
            </div>
            <div class="absolute left-44 flex">
            ...
            <div
               class="overflow-hidden mt-10 xl:col-span-6 lg:col-span-11 col-span-12 bg-gradient-to-b from-primary-lighter-2 to-primary-darker lg:row-span-3 row-span-2 rounded-2xl">
               <canvas ref="myChart" class="p-5  w-full"></canvas>
            </div>
            <div
               class="xl:col-span-5 lg:col-span-11 col-span-12 bg-gradient-to-b from-primary-lighter-2 to-primary-darker row-span-1 rounded-2xl">
            ...
            <div
               class="xl:col-span-5 lg:col-span-11 grid grid-rows-6 grid-cols-2 overflow-hidden shadow-lg col-span-12 bg-white row-span-2 rounded-2xl">
            ...
            <div
               class="xl:col-span-3 lg:col-span-11 col-span-12 p-8 relative overflow-hidden bg-gradient-to-bl from-purple-500 to-blue-500 row-span-2 rounded-2xl">
